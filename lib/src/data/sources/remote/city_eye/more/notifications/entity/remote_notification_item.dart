import 'package:city_eye/src/data/sources/remote/city_eye/more/notifications/entity/remote_notification_priority.dart';
import 'package:city_eye/src/data/sources/remote/city_eye/more/notifications/entity/remote_notification_source.dart';
import 'package:city_eye/src/data/sources/remote/city_eye/more/notifications/entity/remote_notification_type.dart';
...
extension RemoteNotificationItemExtension on RemoteNotificationItem {
  NotificationItem mapToDomain() => NotificationItem(
        ...
        targetId: targetId ?? "",
        notificationType:
            (notificationType ?? const RemoteNotificationType()).mapToDomain(),
        notificationPriority:
            (notificationPriority ?? const RemoteNotificationPriority())
                .mapToDomain(),
        notificationSource:
            (notificationSource ?? const RemoteNotificationSource())
                .mapToDomain(),
      );
}
