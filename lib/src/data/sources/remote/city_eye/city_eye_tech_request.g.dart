...
part of 'city_eye_tech_request.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CityEyeTechRequest<T> _$CityEyeTechRequestFromJson<T>(
  Map<String, dynamic> json,
  T Function(Object? json) fromJsonT,
) =>
    CityEyeTechRequest<T>(
...
Map<String, dynamic> _$CityEyeTechRequestToJson<T>(
  CityEyeTechRequest<T> instance,
