...
import 'package:city_eye/src/presentation/screens/badge_details/widgets/badge_details_widget.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class BadgeDetailsCardWidget extends StatelessWidget {
  final void Function() onPressedCall;
  final bool isValid;
  final UserUnitInfo userUnitInfo;
  final BadgeScanned badgeScanned;
  const BadgeDetailsCardWidget({
    super.key,
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: BadgeDetailsWidget(
                isValid: isValid,
                onPressedCall: onPressedCall,
                badgeScanned: badgeScanned,
