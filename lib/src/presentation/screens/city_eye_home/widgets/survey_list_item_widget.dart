                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              convertTimestampToDateDateFormat(survey.endDate),
                              style: Theme.of(context)
                                  .textTheme
                                  .bodyMedium
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, optionIndex) {
                          return CustomEventsButtonOptionWidget(
                            onTap: () {
                              onOptionSelected(survey.choice[optionIndex]);
                            },
                            buttonTitle: survey.choice[optionIndex].value,
                            isSelected: isSelected &&
                                survey.value ==
                                    survey.choice[optionIndex].id.toString(),
                          );
                        },
